    ...
    <div className="min-h-screen bg-app-cream">
          ...
          <main className="flex-1">
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <button className="px-5 text-s font-medium bg-app-green text-white rounded-xl hover:bg-app-green-light transition-colors">
                  Filters
                </button>
              </div>
            ) : (
      ...
      {mobileFiltersOpen && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
