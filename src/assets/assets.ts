...
export const footerData = {
  ...
  contact: [
    { icon: MapPinIcon, text: "123 Example Rd, Johannesburg" },
    { icon: PhoneIcon, text: "+27 123 456 789" },
    { icon: MailIcon, text: "example@instacart.com" },
  ],

  bottom: {
    copyright: "© 2026 Built By - Sage Aaron Padayachee",
    links: [
